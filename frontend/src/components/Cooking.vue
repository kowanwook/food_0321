<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="Dishname" v-model="value.dishname" :editMode="editMode"/>
            <Number label="OrdNo" v-model="value.ordNo" :editMode="editMode"/>
            <String label="FoodStatusYn" v-model="value.foodStatusYn" :editMode="editMode"/>
        </v-card-text>
